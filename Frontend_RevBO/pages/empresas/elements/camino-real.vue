  ...
  <div class="principal-container">
    <div class="content-container">
      <div class="logo-container">
        <div class="logo">
          <img src="https://seeklogo.com/images/H/Hotel_Camino_Real-logo-573848A35E-seeklogo.com.png">
        </div>
        <div class="empresa">
          <h2>Hotel Camino Real</h2>
          <p>
            <span class="reviews">4,620 reviews</span>
            <span class="porcentaje">4.8/5</span>
          </p>
          <p class="stars">
