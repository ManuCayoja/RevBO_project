  ...
  <div class="principal-container">
    <div class="content-container">
      <div class="logo-container">
        <div class="logo">
          <img src="https://seeklogo.com/images/P/pollos-copacabana-logo-27F5561098-seeklogo.com.png">
        </div>
        <div class="empresa">
          <h2>Pollos Copacabana</h2>
          <p>
            <span class="reviews">7,328 reviews</span>
            <span class="porcentaje">4.7/5</span>
          </p>
          <p class="stars">
      ...
      <div class="calificaciones">
        <h3>Reseñas - 4.7 <span class="star">★</span></h3>
        <p class="total-reviews">7,328 total</p>
        <div
...
export default {
  ...
  setup() {
    ...
    const newReview = ref('');
    const reviews = ref([
      { name: 'Paola Medrano', stars: 5, comment: 'Excelente servicio!', likes: 16, dislikes: 3 }
    ]);
    const ratingsDistribution = ref([21, 72, 3, 2, 2]);
