  ...
  <div class="principal-container">
    <div class="content-container">
      <div class="logo-container">
        <div class="logo">
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR5zJqVUQSv7_Xgjc-otm8wXqHSq9oPqDCiNA&s">
        </div>
        <div class="empresa">
          <h2>Fair Play</h2>
          <p>
            <span class="reviews">2,328 reviews</span>
            <span class="porcentaje">3.9/5</span>
          </p>
          <p class="stars">
      ...
      <div class="calificaciones">
        <h3>Reseñas - 3.9 <span class="star">★</span></h3>
        <p class="total-reviews">2,328 total</p>
        <div
...
export default {
  ...
  setup() {
    ...
    const ratingsDistribution = ref([6, 87, 3, 2, 2]);
