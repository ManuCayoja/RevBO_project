  ...
  <div class="principal-container">
    <div class="content-container">
      <div class="logo-container">
        <div class="logo">
          <img src="https://hipermaxi.com/wp-content/uploads/2021/04/logo@2x.png">
        </div>
        <div class="empresa">
          <h2>Hipermaxi</h2>
          <p>
            <span class="reviews">987 reviews</span>
            <span class="porcentaje">3.8/5</span>
          </p>
          <p class="stars">
      ...
      <div class="calificaciones">
        <h3>Reseñas - 3.8 <span class="star">★</span></h3>
        <p class="total-reviews">987 total</p>
        <div
...
export default {
  ...
  setup() {
    ...
    const newReview = ref('');
    const reviews = ref([
      { name: 'Paola Medrano', stars: 3, comment: 'Muy mal servicio.', likes: 10, dislikes: 4 }
    ]);
    const ratingsDistribution = ref([18, 6, 65, 3, 8]);
