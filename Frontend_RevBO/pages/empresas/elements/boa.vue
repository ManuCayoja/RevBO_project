  ...
  <div class="principal-container">
    <div class="content-container">
      <div class="logo-container">
        <div class="logo">
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQHc2vjQvqHtzb6b1rMF-Up1itZ2Xl0W47nJg&s">
        </div>
        <div class="empresa">
          <h2>Boa</h2>
          <p>
...
export default {
  ...
  setup() {
    ...
    const newReview = ref('');
    const reviews = ref([
      { name: 'Paola Medrano', stars: 1, comment: 'Muy mal servicio.', likes: 18, dislikes: 4 }
    ]);
