  ...
  <div class="principal-container">
    <div class="content-container">
      <div class="logo-container">
        <div class="logo">
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ--1MJsy7_DWpEDHBVdc8L7Vn-neqF-M_MyA&s" alt="Burger King">
        </div>
        <div class="empresa">
          <h2>Burger King</h2>
          <p>
...
export default {
  ...
  setup() {
    ...
    const newReview = ref('');
    const reviews = ref([
      { name: 'Paola Medrano', stars: 5, comment: 'Muy buen servicio! La comida estaba deliciosa y la entrega fue muy rápida.', likes: 16, dislikes: 3 }
    ]);
